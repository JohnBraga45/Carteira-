...
import cv from '../assets/DevJS-CV.pdf'
...
import about from '../assets/images/home-img.jpg'
              ...
              <div className="row-2">
                <div className="skills">
                  ...
                  <div className="progress">
                    <h3>
                      {" "}
                      JavaScript (ES6 + OO) <span> 60% </span>{" "}
                    </h3>
                    <div className="bar">
                      {" "}
                      <span />{" "}
                  ...
                  <div className="progress">
                    <h3>
                      {" "}
                      Automated Tests(Cypress) <span> 55% </span>{" "}
                    </h3>
                    <div className="bar">
                      {" "}
                      <span />{" "}
